...
type FollowingListScreenProps = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'FollowingList'>;
  route: RouteProp<RootStackParamList, 'FollowingList'>;
};
...
export default function FollowingListScreen({ navigation, route }: FollowingListScreenProps) {
  ...
  const fetchFollowing = useCallback(async (offset: number = 0, refresh: boolean = false) => {
    try {
      const data = await api.getFollowing(userId, 20, offset);
      ...
      showToast('Erro ao carregar seguindo', 'error');
    } finally {
      setLoading(false);
      setRefreshing(false);
  ...
  }, [loadingMore, hasMore, following.length, fetchFollowing]);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.navHeader}>
        ...
        <View style={styles.headerTitleContainer}>
          <Text style={styles.navTitle}>Seguindo</Text>
      ...
      <View style={styles.countContainer}>
        <Text style={styles.countText}>{total} seguindo</Text>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Não segue ninguém ainda</Text>
          </View>
        }
